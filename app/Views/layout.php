...
<html lang="en">
  <head>
      ...
      <!-- base css -->
      <link rel="stylesheet"  href="<?php echo base_url('assets/css/smart-admin/vendors.bundle.css') ?>">
      <link rel="stylesheet"  href="<?php echo base_url('assets/css/smart-admin/app.bundle.css') ?>">
      <link rel="stylesheet"  href="<?php echo base_url('assets/css/smart-admin/skin-master.css') ?>">
  ...
  <body class="mod-bg-1 ">
                ...
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            ...
                            <li class="nav-title">Navigate Here</li>
                            <li>
                                <a href="#" title="Users" data-filter-tags="category">
                                    <i class="fal fa-file"></i>
                                    <span class="nav-link-text" data-i18n="nav.category">Users</span>
                                </a>
                                <ul>
                                    <li>
                                        <a href="/users/create" title="Create User" data-filter-tags="utilities menu child">
                                            <span class="nav-link-text" data-i18n="nav.utilities_menu_child">Create User</span>
                                        </a>
                                        <a href="/users/list" title="List Users" data-filter-tags="utilities menu child">
                                            <span class="nav-link-text" data-i18n="nav.utilities_menu_child">List Users</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                ...
                <div class="page-content-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Sample App</a></li>
                            ...
                            <h1 class="subheader-title">
                              ...
                              <span class='fw-300'>
                                <? if(isset($subTitle)): ?>
                                  <?= $subTitle ?>
                                <? endif; ?>
                              </span> <sup class='badge badge-primary fw-500'>
                                <? if(isset($badge)): ?>
                                  <?= $badge ?>
                                <? endif; ?>
                              </sup>
    ...
    <script src="<?php echo base_url('assets/js/smart-admin/vendors.bundle.js') ?>"></script>
    <script src="<?php echo base_url('assets/js/smart-admin/app.bundle.js') ?>"></script>
